                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <Link className="px-6 py-2 text-white bg-blue-500 rounded-md focus:outline-none" :href="route('userinfos.index')"> Back</Link>
                        </div>
                        ...
                        <form name="createForm" @submit.prevent="submit" enctype="multipart/form-data">
                            <div className="flex flex-col">
                                ...
                                <div className="mb-4">
                                    ...
                                    <BreezeInput id="contact" type="number" name="contact" class="mt-1 block w-full" v-model="form.contact" required />
                                ...
                                <div className="mb-4">
                                    ...
                                    <BreezeInput type="radio" id="gender" name="gender" value="Male" v-model="form.gender" required />&nbsp;Male&nbsp;&nbsp;
                                    <BreezeInput type="radio" id="gender" name="gender" value="Female" v-model="form.gender" required />&nbsp;Female&nbsp;&nbsp;
                                    <BreezeInput type="radio" id="gender" name="gender" value="Other" v-model="form.gender" required />&nbsp;Other&nbsp;&nbsp;
                                ...
                                <div className="mb-4">
                                    ...
                                    <BreezeInput id="profile_pic" type="file" name="profile_pic" class="mt-1 block w-full" v-model="form.profile_pic" required />
                                ...
                                <!-- User Id -->
                                <div className="mb-4">
                                    <BreezeInputLabel for="user_id" value="" />
                                    <BreezeInput id="user_id" type="number" name="user_id" class="mt-1 block w-full" v-model="form.user_id" disable />
                                    <span className="text-red-600" v-if="form.errors.user_id">
                                        {{ form.errors.user_id }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="mt-4">
                                <button type="submit" className="px-6 py-2 font-bold text-white bg-green-500 rounded">Save
                                </button>
                            </div>
                        </form>
                    </div>
